...
namespace Antmicro.Renode.Peripherals.CPU
{
    ...
    {
        public CortexA7(Machine machine, GIC gic, ulong genericTimerCompareValue, Endianess endianness = Endianess.LittleEndian) : base("cortex-a15", machine, 0, endianness)
        {
