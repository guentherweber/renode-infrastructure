...
namespace Antmicro.Renode.Peripherals.SPI
{
    ...
    public class DRA78x_QSPI : NullRegistrationPointPeripheralContainer<ISPIPeripheral>, IDoubleWordPeripheral, IKnownSize
    {
        ...
        public DRA78x_QSPI(Machine machine) : base(machine)
        {
