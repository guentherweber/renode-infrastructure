...
{
    public class W25xxxQSPI : ISPIPeripheral
    {
        public W25xxxQSPI(MappedMemory underlyingMemory)
        {
            ...
            nonVolatileConfigurationRegister = new WordRegister(this, 0x0000).WithFlag(0, out numberOfAddressBytes, name: "addressWith3Bytes");
            ...
            statusRegister = new ByteRegister(this, 0x02).WithFlag(1, out enable, name: "volatileControlBit");
        ...
        public void Reset()
        {
            ...
            FinishTransmission();
            statusRegister.Write(0x00, 0x02);
        }
        ...
        private void RecognizeOperation(byte firstByte)
        {
            ...
            switch (firstByte)
            {
                ...
                case (byte)Commands.ProgramEraseResume:
                    //                    state = State.RecognizeOperation;
                    break;
        ...
        private ByteRegister statusRegister;
