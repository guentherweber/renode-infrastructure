...
namespace Antmicro.Renode.Peripherals.Timers
{
    ...
    public class SAMD20_Timer : IKnownSize, IDoubleWordPeripheral, IWordPeripheral, IBytePeripheral, IGPIOReceiver
    {
            ...
            if (value == true)
            {
                if (Enable.Value)
                {
                    ...
                    else
                    {
                        ...
                        CC1.Value = (uint)Timer1.Value-38;   //Magic 38 to be more precise
                        MC1.Value = true;
                        UpdateInterrupts();
                    }
                }
